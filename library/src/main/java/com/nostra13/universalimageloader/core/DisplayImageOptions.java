...
public final class DisplayImageOptions {
     ...
     * 默认图片是否转换
     */
    private boolean processDefaultImg;

    /**
     * 默认图片是否使用displayer
     */
    private boolean useDisplayerDefaultImg;
    ...
    private DisplayImageOptions(Builder builder) {
        ...
        processDefaultImg = builder.processDefaultImg;
        useDisplayerDefaultImg = builder.useDisplayerDefaultImg;
    }


    public boolean isProcessDefaultImg() {
        return processDefaultImg;
    }

    public boolean isUseDisplayerDefaultImg() {
        return useDisplayerDefaultImg;
    }
    ...
    public boolean shouldProcess() {
        return preProcessor != null || postProcessor != null;
    }
    ...
    public static class Builder {
        ...
        public Builder shouldProcessDefaultImg(boolean shouldProcessDefaultImg) {
            this.processDefaultImg = shouldProcessDefaultImg;
            return this;
        }

        public Builder shouldUseDisplayerDefaultImg(boolean shouldUseDisplayerDefaultImg) {
            this.useDisplayerDefaultImg = shouldUseDisplayerDefaultImg;
            return this;
        }
    ...
    public static DisplayImageOptions createSimple() {
        return new Builder().shouldProcessDefaultImg(true).shouldUseDisplayerDefaultImg(true).build();
    }
}
