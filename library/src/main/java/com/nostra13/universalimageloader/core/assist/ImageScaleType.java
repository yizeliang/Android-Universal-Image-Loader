...
/**
 * Type of image scaling during decoding.<br/>
 * 解码的时候的图像处理
 * EXACTLY :图像将完全按比例缩小的目标大小<br/>
 * EXACTLY_STRETCHED:图片会缩放到目标大小完全<br/>
 * IN_SAMPLE_INT:图像将被二次采样的整数倍<br/>
 * IN_SAMPLE_POWER_OF_2:图片将降低2倍，直到下一减少步骤，使图像更小的目标大小<br/>
 * NONE:图片不会调整<br/>
 *
